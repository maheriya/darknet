...
void train_compare(char *cfgfile, char *weightfile)
{
    ...
    int imgs = 1024;
    mlist *plist = get_paths("data/compare.train.list");
...
void validate_compare(char *filename, char *weightfile)
{
    ...
    mlist *plist = get_paths("data/compare.val.list");
    //mlist *plist = get_paths("data/compare.val.old");
    char **paths = (char **)list_to_array(plist);
    int N = plist->size/2;
    free_list(plist);
...
void SortMaster3000(char *filename, char *weightfile)
{
    ...
    mlist *plist = get_paths("data/compare.sort.list");
    //mlist *plist = get_paths("data/compare.val.old");
    char **paths = (char **)list_to_array(plist);
    int N = plist->size;
    free_list(plist);
...
void BattleRoyaleWithCheese(char *filename, char *weightfile)
{
    ...
    mlist *plist = get_paths("data/compare.sort.list");
    //mlist *plist = get_paths("data/compare.small.list");
    //mlist *plist = get_paths("data/compare.cat.list");
    //mlist *plist = get_paths("data/compare.val.old");
    char **paths = (char **)list_to_array(plist);
    int N = plist->size;
    int total = N;
